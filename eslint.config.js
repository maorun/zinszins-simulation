...
export default [
  ...
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      ], // Adjusted from 50 to 85 to accommodate Prettier formatting while maintaining quality standards
  ...
  // Prettier config should be last to disable all conflicting formatting rules
  prettierConfig,
]
