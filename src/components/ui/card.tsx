...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, nestingLevel = 0, ...props }, ref) => {
  ...
  return <div ref={ref} className={cn(nestingClasses, className)} data-nesting-level={nestingLevel} {...props} />
})
...
const CardHeader = React.forwardRef<HTMLDivElement, CardHeaderProps>(
  ({ className, nestingLevel = 0, ...props }, ref) => {
    ...
    return <div ref={ref} className={cn(nestingClasses, className)} {...props} />
  },
)
