 ...
 */
export function AdvancedSimulationSettings({
  config,
  onChange,
}: AdvancedSimulationSettingsProps) {
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        <Switch
          checked={config.useCorrelation}
          onCheckedChange={useCorrelation => onChange({ useCorrelation })}
        />
        <Label className="text-sm">Historische Korrelationen verwenden</Label>
      </div>
      <p className="text-xs text-gray-600">
        Berücksichtigt die historischen Korrelationen zwischen den Anlageklassen für
