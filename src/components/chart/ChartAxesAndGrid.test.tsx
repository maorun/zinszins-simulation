...
describe('ChartAxesAndGrid', () => {
  ...
  it('should render axes and grid components', () => {
    const { container } = render(
      <AreaChart width={500} height={300} data={[]}>
        <ChartAxesAndGrid xAxisAngle={0} xAxisTextAnchor="middle" xAxisHeight={30} formatYAxisTick={formatYAxisTick} />
      </AreaChart>,
    )
  ...
  it('should render with angled x-axis configuration', () => {
    const { container } = render(
      <AreaChart width={500} height={300} data={[]}>
        <ChartAxesAndGrid xAxisAngle={-45} xAxisTextAnchor="end" xAxisHeight={60} formatYAxisTick={formatYAxisTick} />
      </AreaChart>,
    )
