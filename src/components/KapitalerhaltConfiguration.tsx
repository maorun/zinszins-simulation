    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm text-gray-500">
            <span>0%</span>
            <span className="font-medium text-gray-900">{currentValues.nominalReturn.toFixed(1)}%</span>
            <span>15%</span>
          </div>
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm text-gray-500">
            <span>0%</span>
            <span className="font-medium text-gray-900">{currentValues.inflationRate.toFixed(1)}%</span>
            <span>8%</span>
          </div>
        </div>
        <div className="text-sm text-muted-foreground">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
        <div className="text-sm">
          ...
          <div className="text-blue-800">
            {currentValues.nominalReturn.toFixed(1)}% - {currentValues.inflationRate.toFixed(1)}% = <strong>{realReturn.toFixed(1)}%</strong>
          </div>
