...
import { predefinedScenarios, getScenarioCategories, searchScenarios, type FinancialScenario } from '../data/scenarios'
    ...
    <CardContent className="space-y-4">
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-sm text-blue-800">
          <strong>Lernszenarien entdecken:</strong> Erkunden Sie vordefinierte Finanzszenarien, um verschiedene
          Anlagestrategien kennenzulernen. Jedes Szenario zeigt realistische Beispiele mit Lernpunkten und Risiken.
        </AlertDescription>
      </Alert>

      {/* Search */}
      <ScenarioSearchBar searchQuery={searchQuery} onSearchChange={onSearchChange} onClearSearch={onClearSearch} />
