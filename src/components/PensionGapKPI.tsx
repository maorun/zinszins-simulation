      ...
      <CardContent className="space-y-4">
        {hasSurplus ? (
          <Alert>
            ...
            <AlertDescription>
              <strong>Keine Rentenlücke:</strong> Die erwartete Rente übersteigt Ihr Wunscheinkommen.
          ...
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              <strong>Keine Rentenlücke:</strong> Die erwartete Rente deckt Ihr Wunscheinkommen vollständig.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
