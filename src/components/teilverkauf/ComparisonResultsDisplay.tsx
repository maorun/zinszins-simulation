...
function StrategyCard({ title, isBest, initialLiquidity, costsLabel, costsValue, finalWealth, isPositiveCosts }: StrategyCardProps) {
  return (
    <Card>
      <CardHeader>
  ...
  return (
    <div className="space-y-4 pt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StrategyCard title="Teilverkauf" isBest={bestStrategy.name === 'Teilverkauf'} initialLiquidity={result.teilverkauf.initialLiquidity} costsLabel="Gesamtkosten" costsValue={result.teilverkauf.totalCosts} finalWealth={result.teilverkauf.finalWealth} />
        <StrategyCard title="Vollverkauf + Miete" isBest={bestStrategy.name === 'Vollverkauf + Miete'} initialLiquidity={result.fullSaleRent.initialLiquidity} costsLabel="Gezahlte Miete" costsValue={result.fullSaleRent.totalRentPaid} finalWealth={result.fullSaleRent.finalWealth} />
        <StrategyCard title="Leibrente" isBest={bestStrategy.name === 'Leibrente'} initialLiquidity={result.leibrente.initialLiquidity} costsLabel="Erhaltene Zahlungen" costsValue={result.leibrente.totalPaymentsReceived} finalWealth={result.leibrente.finalWealth} isPositiveCosts={true} />
      </div>
