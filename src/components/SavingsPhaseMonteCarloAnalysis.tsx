...
const SavingsPhaseMonteCarloAnalysis = () => {
    ...
    const accumulationConfig: RandomReturnConfig = {
    ...
    const scenarios = createScenarios(accumulationConfig);

    return (
        <div style={{ marginBottom: '30px' }}>
            <h4 style={{ color: '#1976d2', marginBottom: '15px' }}>📊 Monte Carlo Analyse - Ansparphase</h4>
            <div style={{ marginBottom: '20px' }}>
                <p>
                    <strong>Simulationsparameter:</strong> Durchschnittliche Rendite {formatPercent(accumulationConfig.averageReturn)}, 
                    Volatilität {formatPercent(accumulationConfig.standardDeviation || 0.15)}
                </p>
                <p>
                ...
                {accumulationConfig.seed && (
                    <p>
                        <strong>Zufallsseed:</strong> {accumulationConfig.seed} (deterministische Ergebnisse)
                    </p>
                )}
            </div>
