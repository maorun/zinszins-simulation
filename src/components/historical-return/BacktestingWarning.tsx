      ...
      <CardContent nestingLevel={nestingLevel} className="pt-4">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            <div className="font-semibold text-amber-800">Wichtiger Hinweis zum Backtesting</div>
            <div className="text-sm text-amber-700 space-y-1">
              ...
              <p>
                Vergangene Wertentwicklungen sind kein verlässlicher Indikator für künftige Ergebnisse. Märkte können
                sich fundamental ändern.
              </p>
            </div>
          </div>
        </div>
