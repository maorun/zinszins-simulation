...
import { calculateCurrentAge, calculateEndOfLifeYear, getDefaultLifeExpectancy } from '../../helpers/life-expectancy'
...
export function GlobalPlanningConfiguration() {
  const {
    setEndOfLife,
    birthYear,
    setBirthYear,
  ...
  return (
    <CollapsibleCard id="global-planning" navigationTitle="Globale Planung (Einzelperson/Ehepaar)" navigationIcon="👥">
      <CollapsibleCardHeader>👥 Globale Planung (Einzelperson/Ehepaar)</CollapsibleCardHeader>
...
function LifeExpectancy() {
  ...
  return (
    <CollapsibleCard navigationId="life-expectancy" navigationTitle="Lebensende Berechnung" navigationIcon="🕰️">
      <CollapsibleCardHeader>🕰️ Lebensende Berechnung</CollapsibleCardHeader>
      <CollapsibleCardContent>
