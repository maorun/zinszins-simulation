...
function EnhancedOverview() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
      <h3 className="bg-gradient-to-r from-slate-700 to-slate-600 text-white m-0 p-6 text-xl font-bold text-center tracking-tight">
        🎯 Finanzübersicht - Schnelle Eckpunkte
      </h3>
      <div className="p-6 border-b border-gray-200">
        <h4 className="m-0 mb-4 text-slate-700 text-lg font-semibold flex items-center gap-2">
        ...
        <div className="p-6 border-b border-gray-200">
          <h4 className="m-0 mb-4 text-slate-700 text-lg font-semibold flex items-center gap-2">
            ...
            {enhancedSummary.isSegmentedWithdrawal && enhancedSummary.withdrawalSegments && enhancedSummary.withdrawalSegments.length > 1 && (
              <span className="text-sm text-cyan-600 font-normal"> - {enhancedSummary.withdrawalSegments.length} Phasen</span>
            )}
          </h4>
          ...
          {enhancedSummary.isSegmentedWithdrawal && enhancedSummary.withdrawalSegments && enhancedSummary.withdrawalSegments.length > 1 ? (
            ...
            <div className="flex flex-col gap-4">
              {enhancedSummary.withdrawalSegments.map((segment) => (
                <div key={segment.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4 border-l-4 border-l-cyan-600">
                  <h5 className="m-0 mb-3 text-slate-700 text-base font-semibold">
...
const HomePageContent = () => {
  ...
  return (
    <div className="px-3 mx-auto max-w-full md:px-4 md:max-w-3xl lg:px-6 lg:max-w-5xl xl:max-w-7xl">
      <Header />
