...
describe('betriebsrente', () => {
  ...
  describe('calculateBetriebsrenteTaxBenefit', () => {
    ...
    it('should calculate correctly with different tax rates', () => {
      const result42 = calculateBetriebsrenteTaxBenefit(3000, 2000, 2024, 0.42, 0.20)
      const result25 = calculateBetriebsrenteTaxBenefit(3000, 2000, 2024, 0.25, 0.20)
    ...
    it('should handle zero contributions', () => {
      const result = calculateBetriebsrenteTaxBenefit(0, 0, 2024, 0.35, 0.20)
  ...
  describe('calculateBetriebsrentePensionTaxation', () => {
    ...
    it('should apply pension increase correctly', () => {
      const firstYear = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.02, 0.25, true, true
      )
      const thirdYear = calculateBetriebsrentePensionTaxation(
        2000, 2042, 2040, 0.02, 0.25, true, true
      )
    ...
    it('should calculate higher care insurance for childless individuals', () => {
      const withChildren = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.25, true, true
      )
      const withoutChildren = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.25, true, false
      )
    ...
    it('should not charge social security for private health insurance', () => {
      const statutory = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.25, true, true
      )
      const privateInsurance = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.25, false, true
      )
    ...
    it('should handle different tax rates correctly', () => {
      const lowTax = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.15, true, true
      )
      const highTax = calculateBetriebsrentePensionTaxation(
        2000, 2040, 2040, 0.01, 0.42, true, true
      )
      ...
      expect(lowTax.totalSocialSecurityContributions).toBeCloseTo(
        highTax.totalSocialSecurityContributions,
        0
      )
  ...
  describe('calculateBetriebsrenteLifetimeBenefit', () => {
    ...
    it('should show employer contributions increase total benefit', () => {
      const withEmployer = calculateBetriebsrenteLifetimeBenefit(
        basicConfig,
        2024, 2049, 2074, 0.35, 0.25, 0.20, true, true
      )
    ...
    it('should calculate higher benefit with lower pension tax rate', () => {
      const lowPensionTax = calculateBetriebsrenteLifetimeBenefit(
        basicConfig, 2024, 2049, 2074, 0.35, 0.15, 0.20, true, true
      )
      const highPensionTax = calculateBetriebsrenteLifetimeBenefit(
        basicConfig, 2024, 2049, 2074, 0.35, 0.42, 0.20, true, true
      )
    ...
    it('should show benefit of private vs statutory health insurance in retirement', () => {
      const statutory = calculateBetriebsrenteLifetimeBenefit(
        basicConfig, 2024, 2049, 2074, 0.35, 0.25, 0.20, true, true
      )
      const privateInsurance = calculateBetriebsrenteLifetimeBenefit(
        basicConfig, 2024, 2049, 2074, 0.35, 0.25, 0.20, false, true
      )
    ...
    it('should handle shorter contribution period', () => {
      ...
      const shortContribution = calculateBetriebsrenteLifetimeBenefit(
        basicConfig, 2034, 2049, 2074, 0.35, 0.25, 0.20, true, true
      )
    ...
    it('should handle edge case of zero contributions', () => {
      ...
      const result = calculateBetriebsrenteLifetimeBenefit(
        zeroConfig, 2024, 2049, 2074, 0.35, 0.25, 0.20, true, true
      )
  ...
  describe('Integration scenarios', () => {
    it('should demonstrate typical employee scenario', () => {
      ...
      const benefit2024 = calculateBetriebsrenteTaxBenefit(2400, 1200, 2024, 0.35, 0.20)
    ...
    it('should demonstrate high-earner scenario exceeding limits', () => {
      ...
      const benefit2024 = calculateBetriebsrenteTaxBenefit(6000, 3600, 2024, 0.42, 0.20)
    ...
    it('should compare early vs late retirement', () => {
      ...
      const normalRetirement = calculateBetriebsrenteLifetimeBenefit(
        config, 2024, 2049, 2074, 0.35, 0.25, 0.20, true, true
      )

      // Retire at 67, live to 87 (20 years of pension)
      const shorterLife = calculateBetriebsrenteLifetimeBenefit(
        config, 2024, 2049, 2069, 0.35, 0.25, 0.20, true, true
      )
